...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/ico_effects.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/ico_settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/ico_power.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/ico_information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/ico_devices.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/ico_strips.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/ico_debug.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.main_menus.setGeometry(QtCore.QRect(230, 0, 681, 541))
        ...
        self.effects_scroll_region_widgets = QtWidgets.QWidget()
        self.effects_scroll_region_widgets.setGeometry(QtCore.QRect(0, 0, 671, 541))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.effects_scroll_region_widgets.sizePolicy().hasHeightForWidth())
        self.effects_scroll_region_widgets.setSizePolicy(sizePolicy)
        self.effects_scroll_region_widgets.setMinimumSize(QtCore.QSize(0, 0))
        self.effects_scroll_region_widgets.setObjectName("effects_scroll_region_widgets")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.effects_scroll_region_widgets)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_menu_effect_new.sizePolicy().hasHeightForWidth())
...
"border-radius: 10px;")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(100, 100, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.settings_toggle_advanced_layout.addItem(spacerItem2)
...
"border-radius: 10px;")
        ...
        self.settings_option_update_layout.addItem(spacerItem5)
